...
public class Var_02 {
	...
	public static void main(String[] args) {
		...
		// boolean type 변수 선언하고 intNum1 과 intNum2의 값을 비교(>=)하여
		// 나타난 결과 (true or false)를 변수에 저장
