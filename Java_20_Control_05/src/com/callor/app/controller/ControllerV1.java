...
public class ControllerV1 {
	...
	public static void main(String[] args) {
		...
		// scorePrint(); 는 void type이었기 때문에 변수가 붙지않고(결과를 변수에 담을 수 없음) 단독으로 호출한다,
		serviceV1.scorePrint();
		
		// scoreSum() 은 return type int형이다.
		// scoreSum() 과목의 총점을 계산하여 결과를 return하고있다.
		// scoreSum() 에서는 scoreSum()을 호출하여 결과를 어딘가에 담아서 출력하는 일을 수행해야 하는데
