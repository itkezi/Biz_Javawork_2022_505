...
public class StudentServiceV1 {
	...
	// 기본 생성자
	// class를 선언하면 자동으로 선언되는 생성자 method
	public StudentServiceV1() {

		// strStudent, scan 두 개의 변수는 초기화가 되어야 하는데
		// 생성자에 초기화 시키는 코드를 작성한다
		// 하지만 현재 ServiceV1 클래스에는 두개의 생성자가 있다.
		// 그래서 기본 생성자에서는 임의 생성자에게 정수 10을 전달하면서
		// strStudent 와 scan 두 개의 변수를 초기화 하도록 toss 해버린다.
		// this(10);
	...
	// 임의 생성자
	// class 개발자가 필요에 의해 임의로 선언하는 생성자 method
