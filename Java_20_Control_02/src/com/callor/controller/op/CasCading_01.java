...
public class CasCading_01 {
	...
	public static void main(String[] args) {
		...
		// 이것은 오차에 대한 안전장치이다.
		// 경우에 따라 소수점 이하 값을 무시하고 강제로 형 변환을 하여 실수값을 정수형 변수에 대입하기도 한다
		intNum1 = (int)3.0 ;
		intNum1 += 3.0;
		
		// 복합 연산자가 포함된 식에서는 실수값을 정수값에 대입하는데 문법 오류가 나지 않는다
		// 내부적으로 강제 형변환이 일어나기 때문이다.
		// 값을 예측할 수 없고 논리적인 문제를 일으키지 않으면 많은 값을 대입하여 오류를 방지해야 한다.
		intNum1 = 0;
		intNum1 += 3.123123123;
