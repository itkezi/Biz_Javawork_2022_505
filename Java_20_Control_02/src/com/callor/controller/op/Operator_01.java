...
public class Operator_01 {
	...
	public static void main(String[] args) {
		...
		// 명령문 (statement)
		// java 코드에서 명령문은 반드시 끝에 세미 콜론(;)이 온다
		// 명령문의 시작은 key words와 변수만 올 수 있다.
		// key words로 시작하는 명령문은 어떤 기능은 수행하는 경우이고 변수로 시작하는 경우는 연산자가 따라온다
		// 변수의 바로 다음에 오는 연산자 대입연산자(=), 단항연산자(++, --), 복합연산자(+=, *=, -=, /=, %=), 삼항연산자 등이 있다.
		...
		// 단항연산자 : 혼자 스스로 1을 증가시키고 그 값은 intNum2에 저장
		...
		intNum2 = intNum1; // intNum1에 저장된 값은 intNum2에 복사하라
		System.out.println(intNum2);

		// 복합연산자 : 먼저 앞의 변수이름이 설정된 기억장치에서 값을 읽어온 후 연산(여기서는 +10)을 실행하고 결과를 맨앞의 변수에 저장하라.
