...
public class Var_01 {
	...
	// public static void main() {} : java 시작정, 진입점 method 명령 그룹이라고 한다.
	...
	public static void main(String[] args) {
		...
		// function, 함수라고 한다. method는 함수에 포함되는 개념이다.
		// method는 단독으로 사용하지 않고 다른 키워드와 조합으로 사용되는 경우가 많다.
		
		// 명령문의 조합
		// 명령문은 키워드1 키워드2 키워드3처럼 빈칸으로 키워드를 구분하거나 
		// 키워드1.키워드2.키워드3 처럼 Dot(.)으로 키워드를 구분하여 하나의 명령문(statement)를 구현(명령문을 문법에 맞게 완성) 한다.
		//
		...
		// ()안에 어떤 값을 첨가하는데 이것을 아규먼트(argument, args)라고 한다.
		// method에 따라 args가 있거나 없거나 상관 없이 작동 되기도 하고 없으면 문법 오류를 발생하기도 한다.
		// method에 첨가되는 args는 method 코드가 만들어질 때 정해지는 것으로 특별한 규칙이 없다.
		// 사용하는 사람이 잘~ 찾아서 사용해야 한다.
		System.out.print(0);
		System.out.print(0 + 0);
		System.out.print("대한민국");
		// \n = 줄바꿈 = ln
		// \n은 특수문자 취급이라 화면에서 보이지 않는다 하지만 \\n은 보임 (특수문자를 출력하려면 \를 하나 더 붙인다)
		System.out.print("\n");
