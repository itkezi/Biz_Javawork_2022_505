...
public class ObjectEx2 {
	...
	private static void printScore(ScoreVO[] stVOs) {
		System.out.println("=".repeat(50));
		System.out.println("학번\t국어\t영어\t수학");
		System.out.println("-".repeat(50));
		for(ScoreVO scVO : stVOs ) {
