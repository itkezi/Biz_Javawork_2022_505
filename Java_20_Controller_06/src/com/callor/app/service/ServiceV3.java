...
// scoreSum()에서 계산한 총점과 scorePrint()에서 출력한 과목 점수와의 관계에선 문제가 발생한다/
// 두 method에서 선언된 intKor, intEng, intMath는 이름은 같지만 완전히 다른 변수(저장공간, 값이 다른) 이다.
//
...
public class ServiceV3 {
	...
	public void scorePrint() {
		...
		// String(문자열) type의 변수는 실체는 String 클래스 type의 인스턴스이다.
