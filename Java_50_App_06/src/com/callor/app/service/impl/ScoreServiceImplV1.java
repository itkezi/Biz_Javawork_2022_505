...
public class ScoreServiceImplV1 implements ScoreService {
	...
	// Service 클래스에서 필요한 데이터를 클래스 영역에 선언할 때는 final키워드를 생성하자
	// final 키워드를 부착하면 혹시 모를 데이터 손상(데이터가 저장된 상태에서 또 다시 초기화)을 방지하고
	...
	public ScoreServiceImplV1() {
		// 생성자에서 리스트 객체를 초기화하여 NullPointerException을 사전에 예방
